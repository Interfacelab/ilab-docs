...
gulp.task('clearviews',  require('del').bind(null, '../../../../cache/views', {force: true}));

gulp.task('watch', function() {
    gulp.watch(['../views/**/*.php','../views/**/*.twig','../views/**/*.html'], ['clearviews']);
    browserSync.init({
        files: ['../views/**/*.php','../views/**/*.twig','../views/**/*.html'],
        proxy: config.devUrl,
        ghostMode: false,
        snippetOptions: {
        }
